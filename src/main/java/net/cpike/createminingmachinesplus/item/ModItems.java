...
public class ModItems {
  ...
  // 2. (optional) in CreateMiningMachinesPlus.java, add a 'event.accept' call to
  // the addCreative function.
  // 3. go to resources/lang/en_us.json and add an entry to translate for the game
  // 4. go to /models/item and add a <name>.json file, note that <name> must be
  // the 'name:' specified in the RegistryObject<Item> instance.
